...
class Machine():
    ...
    def draw(self):
        self.image.clip_draw(0,0,400,1000,200,500)
    def update(self):
        pass
class Effect_1():
    global x
...
def enter():
    global fermion, life_gauge, machine, effect_1, note , score_gauge
...
def exit():
    global fermion, life_gauge, machine,note,score_gauge
    del(fermion)
    del(life_gauge)
    del(machine)
    del(note)
